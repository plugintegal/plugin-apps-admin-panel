  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xl-3 col-md-6">
        <div class="card-box">
          <h4 class="header-title mt-0 mb-4">Total Anggota</h4>
      ...
      <div class="col-xl-3 col-md-6">
        <div class="card-box">
          <h4 class="header-title mt-0 mb-3">Anggota Aktif</h4>
      ...
      <div class="col-xl-3 col-md-6">
        <div class="card-box">
          ...
          <h4 class="header-title mt-0 mb-4">Anggota Tidak Aktif</h4>
      ...
      <div class="col-xl-3 col-md-6">
        <div class="card-box">
          ...
          <h4 class="header-title mt-0 mb-3">hahahah</h4>
            ...
            <ul class="list-inline chart-detail-list mb-0">
              <li class="list-inline-item">
                <h5 style="color: #ff8acc;">
                  <i class="fa fa-circle mr-1"></i>Series A
                </h5>
              </li>
              <li class="list-inline-item">
                <h5 style="color: #5b69bc;">
                  <i class="fa fa-circle mr-1"></i>Series B
                </h5>
              </li>
            </ul>
          </div>
